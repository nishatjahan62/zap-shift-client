  ...
  <div className="w-full md:w-1/2 p-4 flex items-center">
    <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium">Your NID Number</label>
          <input
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium">Your Bike Model</label>
          <input
        ...
        <div>
          <label className="block text-sm font-medium">Your License Number</label>
          <input
      ...
      <div>
        <label className="block text-sm font-medium">Your Warehouse (District)</label>
        <select
